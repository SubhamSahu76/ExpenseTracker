 ...
 * @author Subham
 */
public class ViewSpanding extends javax.swing.JFrame {

    /**
     * Creates new form ViewSpanding
     */
    public ViewSpanding() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Spanding Date Category Wise");
        ...
        totalAmount2.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        ...
        jLabel6.setText("View Spanding Date Wise");
        ...
        totalAmount1.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ResultSet rs = db.DbConnect.st.executeQuery("select * from expense where date>='"+dt1+"' and date<='"+dt2+"' order by date asc");
            int total=0;
            while(rs.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs = db.DbConnect.st.executeQuery("select * from expense where date>='"+dt1+"' and date<='"+dt2+"' and category='"+c+"' order by date asc");
            int total=0;
            while(rs.next()){
                int t=rs.getInt("amount");
                total +=t;
